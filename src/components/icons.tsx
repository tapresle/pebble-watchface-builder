...
/* Arrows converging on a box: strays pulled back inside the screen. */
export const CollectIcon = () => (
  <Glyph>
    <rect x="5.5" y="5.5" width="7" height="7" rx="1" />
    <path d="M2 2l2.4 2.4M2 16l2.4-2.4M16 2l-2.4 2.4M16 16l-2.4-2.4" />
  </Glyph>
);

/* Two overlapping squares: several elements bound into one. */
export const GroupIcon = () => (
  <Glyph>
    <rect x="2.5" y="2.5" width="8" height="8" rx="1" />
    <path d="M7.5 7.5h8v8h-8v-3" />
  </Glyph>
);

/* The same pair, pulled apart. */
